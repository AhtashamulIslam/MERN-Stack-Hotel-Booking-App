  ...
  return (
    <div className='min-h-screen mt-30 '>
      <div className='flex flex-col px-8 sm:px-12  max-w-3xl mx-auto md:flex-row md:p-3 md:items-center gap-5 '>
        ...
        <div className='flex-1'>
         <h2 className="text-4xl md:text-center mb-2 text-gray-900 font-medium">Sign up</h2>
          <p className="text-sm md:text-center text-gray-500/90 mt-3">Welcome ! Create an Account to continue</p>
          <div className="flex items-center gap-4 w-full my-5">
                <div className="w-full h-px bg-gray-300/90"></div>
                <p className="w-full text-nowrap text-sm text-gray-500/90">sign up with Email or Google</p>
                <div className="w-full h-px bg-gray-300/90"></div>
            </div>
